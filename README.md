...
[![Github Actions Status](https://github.com/Darshan808/jupyterlab_apod.git/workflows/Build/badge.svg)](https://github.com/Darshan808/jupyterlab_apod.git/actions/workflows/build.yml)
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/Darshan808/jupyterlab_apod.git/main?urlpath=lab)


A JupyterLab extension that displays astronomy picture of the day

This extension is composed of a Python package named `DP_APOD`
for the server extension and a NPM package named `DP_APOD`
...
# Change directory to the DP_APOD directory
...
jupyter server extension disable DP_APOD
pip uninstall DP_APOD
```

In development mode, you will also need to remove the symlink created by `jupyter labextension develop`
command. To find its location, you can run `jupyter labextension list` to figure out where the `labextensions`
folder is located. Then you can remove the symlink named `DP_APOD` within that folder.
